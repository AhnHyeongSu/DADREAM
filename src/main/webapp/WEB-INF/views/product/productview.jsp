            ...
            <div class="dlComments">
                ...
                <div id="dlComments4">
                    <div class="bot">
                        ...
                        <button type="button" id="cart" class="btn btn-secondary btn-lg"><img src="image/cart.png" class="cartimg"></button>
                        <!-- </form> -->
                            ...
                            <div id="toggle" class="replying">
                                <c:forEach var="reply" items="${reply}">
                                    <c:if test="${i.review_Num == reply.review_Num}">
                                        <div id="border">
                                            <p style="color:green">${reply.user_Id} : ${reply.reply_Text}</p>
                                            ...
                                            <c:forEach var="total" items="${totalReply}">
                                                <c:if test="${reply.reply_Count == total.parent_No}">
                                                    <p style="color:red;">${total.user_Id} :
                                                        ${total.reply_Text}</p>
                                                    ...
                                                    <c:forEach var="totaltwo" items="${totalReply}">
                                                        <c:if test="${total.reply_Count == totaltwo.parent_No}">
                                                            <p style="color:orange">${totaltwo.user_Id} :
